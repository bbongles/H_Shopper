			...
			<div class="row">
				<div class="span12">
					<div class="accordion" id="accordion2">
						...
						제목<br/>
						<input type="text" name="bd_title" required /> <br/>
						본문<br/>
						<textarea name="editor" id="editor" rows="10" cols="100" style="width:1000px; height:412px;"></textarea><br/>
						아이디 <input type="text" name="bid" readonly="readonly" value="${b_login_id}"><br/>
<%-- 						<input type="hidden" name="s_id" value="${sellerInfo.s_name}"> --%>
						 <input type="submit" id="savebutton" value="작성 완료">
						</form>
