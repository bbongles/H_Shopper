...
/* .emailclass {
    ...
    <body>		
		...
		<section class="header_text sub">
			...
			<h3 class="titlem"> 
				<span><a href="buyermypage"><strong>판매자 아이디</strong>  찾기</a></span>  
			</h3> 
		...
		<section class="main-content" >
			...
			<div class="row" id="mainrow" >
				...
				<div id="maindi" class="span5" >
					<h3 class="title">
						<span class="text"><strong>본인확인 </strong>이메일로 인증</span>
					</h3>
								...
								<div class="accordion-inner">
									...
									<form action="findidforlogin" id="findform"><!-- ** submit-->
											...
											<div class="control-group">
												<label>가입시 입력한 이름</label> 
												<div class="controls">
													<input class="input-xlarge" type="text" name="s_name" id="s_name"/>
												</div>
											</div>
											...
											<div class="control-group emailclass" >								 	
											 	<label for="s_email">가입시 입력한 이메일 주소 &nbsp;&nbsp; 
											 	<!-- <small id="b_duplicationCheckResult2">
											 	 	유효한 이메일임을 확인하기 위해서 확인메일을 보냅니다.</small> -->
												</label>
												<div class="controls emailclass" id="s_email">
													<input type="email" id='s_email2' name="s_email" class="input-xlarge"
													placeholder="이메일주소 입력 ">
														
												    <span class="input-group-btn emailclass" id="s_check">
											...
											<div class="form-group emailclass" id="confirmForm_form-group">
												<label for="s_email_input">승인번호 입력 &nbsp;&nbsp;</label>
												<div class="controls" id="s_email_input-group">
													<input disabled required type="text" id = "s_email_input"class="input-xlarge"
...
<!-- 													 <input tabindex="9" class="btn btn-inverse large" 
											...
											<!-- -------------------------------------------------------------- -->
 											...
 											<div class="actions">
												...
												type="button" id="btnfindid" >아이디 찾기</button>
											</div>
											<br>
...
<script src="<c:url value='/resources/css/findidjs.js?ver=10' />"></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
