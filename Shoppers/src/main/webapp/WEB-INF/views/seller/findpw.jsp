...
/* .emailclass {
    ...
    <body>		
		...
		<section class="header_text sub">
			...
			<h3 class="titlem"> 
				<span><a href="buyermypage"><strong>판매자 비밀번호</strong>  찾기</a></span>  
			</h3> 
								...
								<div class="accordion-inner">
									...
									<form action="findpwforupdate" id="findform"><!-- ** submit-->
											...
											<div class="control-group">
												<label>아이디</label> 
												<div class="controls">
													<input class="input-xlarge" type="text" name="s_id" id="s_id"/>
												</div>
											</div>
...
<script src="<c:url value='/resources/css/findpwjs.js?ver=13' />"></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
