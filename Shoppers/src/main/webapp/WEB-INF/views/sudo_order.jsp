	...
	<div id="wrapper" class="container">
		<section class="navbar main-menu">
			<div class="navbar-inner main-menu">
				<a href="../buyer/main" class="logo pull-left">
...
<!-- 제품 이미지 --><td><img src="${vo.p_img }" style="width: 50px" /></td> 
	...
	<!--  -->
		...
		기본주소 : <input type="text" id="sample6_address" placeholder="주소" name="delivery_addr1" value="${registedAddr1 }"><br>
		상세주소 : <input type="text" id="sample6_address2" placeholder="상세주소"  name="delivery_addr2" value="${registedAddr2 }"><br>
		</div>		
		<hr>
		<h2>결제방법</h2>
