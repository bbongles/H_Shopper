...
<body>
			...
			<div class="span4">
				<form method="POST" class="search_form" action="search_form">
					<input type="text" class="input-block-level search-query"
						Placeholder="eg. T-sirt" name="searching">
				</form>
			</div>
			<div class="span8">
				<div class="account pull-right">
					<ul class="user-menu">
						...
						<c:if test="${empty s_login_id && empty b_login_id }">
							...
							<li><a href="javascript:window.location.replace('login');">Login</a></li>
						</c:if>
	...
	<div id="wrapper" class="container">
		<div class="navbar-inner main-menu">
			...
			<c:if test="${not empty b_login_id }">
				<a href="main" class="logo pull-left"><img
					src=<c:url value='/resources/themes/images/logo.png' />
					class="site_logo" alt=""></a>
			</c:if>
			<c:if test="${not empty s_login_id and s_login_id ne 'admin'}">
			...
			<nav id="menu" class="pull-right">
				<ul>
					<li><a href="./products?p_cate1=home_deco">Home / Deco</a>
						<ul>
							<li><a href="./products?p_cate2=furniture">furniture</a></li>
							<!-- 가구 -->
							<li><a href="./products?p_cate2=pottery">pottery</a></li>
							<!-- 도자기 -->
							<li><a href="./products?p_cate2=lamp">lamp</a></li>
							<!-- 조명 -->
						</ul></li>
					<li><a href="./products?p_cate1=candle_diffuser">Candle /
							Diffuser</a>
						<ul>
							<li><a href="./products?p_cate2=candle">candle</a></li>
							<!-- 양초 -->
							<li><a href="./products?p_cate2=diffuser">diffuser</a></li>
							<!-- 디퓨저 -->
							<li><a href="./products?p_cate2=aromatic oils">aromatic
									oils</a></li>
							<!-- 아로마오일 -->
						</ul></li>
					<li><a href="./products?p_cate1=art_fancy">Art / Fancy</a>
						<ul>
							<li><a href="./products?p_cate2=picture">picture</a></li>
							<!-- 사진 -->
							<li><a href="./products?p_cate2=fancy">fancy</a></li>
							<!-- 문구 -->
							<li><a href="./products?p_cate2=paper">paper</a></li>
							<!-- 페이퍼 -->
						</ul></li>
					<li><a href="./products?p_cate1=jewellery">Jewellery</a>
						<ul>
							<li><a href="./products?p_cate2=earring">earring</a></li>
							<!-- 귀걸이 -->
							<li><a href="./products?p_cate2=necklace">necklace</a></li>
							<!-- 목걸이 -->
							<li><a href="./products?p_cate2=ring">ring</a></li>
							<!-- 반지 -->
						</ul></li>
			...
			<div class="flexslider">
				<ul class="slides">
					<li>
						...
						<img
						src="http://image.thefingers.co.kr/main/201612/999/999_18853.jpg"
						alt="" />
					<!-- 메인 광고 -->
					</li>
					<li>
						...
						<img
						src="http://image.thefingers.co.kr/main/201612/999/999_18856.jpg"
						alt="" /> <!-- <div class="intro">
					...
					<li>
						<!-- <img src=<c:url value='/resources/themes/images/carousel/banner-2.jpg'/> alt="" /> -->
						<img
						src="http://image.thefingers.co.kr/main/201612/999/999_18852.jpg"
						alt="" /> <!-- <div class="intro">
								<h1>Mid season sale</h1>
								<p><span>Up to 50% Off</span></p>
								<p><span>On selected items online and in stores</span></p>
				...
				<div class="span12">
						...
						<div class="span12">
							<h4 class="title">
								<span class="pull-left"><span class="text"><span
										class="line">New <strong>Products</strong></span></span></span> <span
												...
												<c:forEach begin="0" end="3" varStatus="status"
													...
													<li class="span3">
														<div class="product-box">
															...
															<p>
																<a
																	href="pDetail?p_no=${productList[4 * page + status.index].p_no }"><img
																	src="${productList[4 * page + status.index].p_img }" /></a>
															</p>
															<a
																href="pDetail?p_no=${productList[4 * page + status.index].p_no }"
																class="title">${productList[4 * page + status.index].p_name }</a><br>
															<a
																href="pDetail?p_no=${productList[4 * page + status.index].p_no }"
																class="category">${productList[4 * page + status.index].p_cate1}</a>
															<!-- 카테고리 -->
					...
					<div class="row">
						<div class="span12">
							<h4 class="title">
								<span class="pull-left"><span class="text"><span
										class="line">Event <strong>Products</strong></span></span></span> <span
									class="pull-right"> <a class="left button"
							...
							<div id="myCarousel-2" class="myCarousel carousel slide">
								<div class="carousel-inner">
									...
									<!-- 1페이지 -->
									<!--  TODO : 나중에 할인률 적용되는 상품들을 로직으로 불러오는 것으로 대체 -->
									<div class="active item">
										<ul class="thumbnails">
												...
												<div class="product-box">
													...
													<p>
														<a href="product_detail.html"><img
															src="http://image.thefingers.co.kr/diyitem/webimage/list120/00/C000008255.jpg" /></a>
													</p>
											...
											<li class="span3">
												<div class="product-box">
													<p>
														<a href="product_detail.html"><img
															src="http://image.thefingers.co.kr/diyitem/webimage/list120/00/C000008243.jpg" /></a>
													</p>
											...
											<li class="span3">
												<div class="product-box">
													<p>
														<a href="product_detail.html"><img
															src="http://image.thefingers.co.kr/diyitem/webimage/list120/00/C000008063.jpg" /></a>
													</p>
											...
											<li class="span3">
												<div class="product-box">
													<p>
														<a href="product_detail.html"><img
															src="http://image.thefingers.co.kr/diyitem/webimage/list120/00/C000008040.jpg" /></a>
													</p>
													<a href="product_detail.html" class="title">홀리데이 밍크 드롭
														귀걸이</a><br /> <a href="products.html" class="category">Sara
														and Rosa</a>
										...
										<ul class="thumbnails">
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail.html" class="title">크리스마스
														드라이플라워박스</a><br /> <a href="products.html" class="category">SANSANGGOT</a>
													<p class="price">34,900 원</p>
												</div>
											</li>
											<li class="span3">
											...
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail.html" class="title">홀리데이 밍크 드롭
														귀걸이 (2colors)</a><br /> <a href="products.html"
														class="category">Sara and Rosa</a>
													<p class="price">15,900 원</p>
												</div>
											</li>
										</ul>
					...
					<div class="row feature_box">
						<div class="span4">
							<div class="service">
								<div class="responsive">
									<img
										src=<c:url value='/resources/themes/images/feature_img_2.png'/>
										alt="" />
									<h4>
										SPECIAL <strong>DESIGN</strong>
									</h4>
						...
						<div class="span4">
							<div class="service">
								<div class="customize">
									<img
										src=<c:url value='/resources/themes/images/feature_img_1.png'/>
										alt="" />
									<h4>
						...
						<div class="span4">
							<div class="service">
								<div class="support">
									<img
										src=<c:url value='/resources/themes/images/feature_img_3.png'/>
										alt="" />
									<h4>
		...
		<section class="our_client">
			<h4 class="title">
				<span class="text">Cooperator</span>
			</h4>
			<div class="row">
				<div class="span2">
					<a href="./sellerHome?s_id=s1"><img
						...
						alt=""
						src=<c:url value='/resources/themes/images/clients/co1.png'/>></a>
				</div>
				<div class="span2">
					<a href="#"><img
						onMouseOver="this.style.opacity='.6'; this.style.filter='alpha(opacity=60)'"
						onMouseOut="this.style.opacity='1.0'; this.style.filter='alpha(opacity=100)'"
						src=<c:url value='/resources/themes/images/clients/co2.png'/>></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src=<c:url value='/resources/themes/images/clients/co3.png'/>></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src=<c:url value='/resources/themes/images/clients/co4.png'/>></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src=<c:url value='/resources/themes/images/clients/co5.png'/>></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src=<c:url value='/resources/themes/images/clients/co6.png'/>></a>
				</div>
			</div>
		</section>
	...
	<script
		src=<c:url value='/resources/themes/js/jquery.flexslider-min.js'/>></script>
