    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/notice01/file_uploader2'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/notice01/file_uploader',	//샘플 URL입니다.
 	        sCallback : 'resources/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
